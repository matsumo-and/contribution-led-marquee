...
exports.parseContributions = parseContributions;
exports.getContributionLevels = getContributionLevels;
 ...
 */
function getContributionLevels(grid) {
    return grid.cells.map(row => row.map(cell => cell ? cell.count : 0));
}
